...
def create_app(config_name=None):
    ...
    from app.routes.tariff import tariff_bp
    ...
    with app.app_context():
        try:
            ...
            from app.models import MonthlyGeneration, HourlyGeneration, FinancialResult, Upload, TariffLibrary
    ...
    def make_shell_context():
        ...
        from app.models import FinancialResult, Upload, TariffLibrary
        return {
            "db": db,
            "Project": Project,
            "PVSystem": PVSystem,
